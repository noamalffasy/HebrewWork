...
function (_Component) {
  ...
  _createClass(Question, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      console.log(nextProps.toShow, this.props.toShow, this.state.isOpen);

      if (nextProps.toShow !== this.state.isOpen && this.state.isOpen !== this.props.toShow) {
...
//# sourceMappingURL=index.js.cbe9ed9b2c9c00126fd3.hot-update.js.map